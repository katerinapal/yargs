...
function validation(yargs, usage, y18n) {
  ...
  self.implies = function implies(key, value) {
    (0, _argsert2.default)('<string|object> [array|number|string]', [key, value], arguments.length);
  ...
  self.conflicts = function conflicts(key, value) {
    (0, _argsert2.default)('<string|object> [array|string]', [key, value], arguments.length);
  ...
  self.recommendCommands = function recommendCommands(cmd, potentialCommands) {
    ...
    for (var i = 0, candidate; (candidate = potentialCommands[i]) !== undefined; i++) {
      var d = (0, _levenshtein2.default)(cmd, candidate);
  ...
  self.reset = function reset(localLookup) {
    implied = (0, _objFilter2.default)(implied, function (k, v) {
      return !localLookup[k];
    });
    conflicting = (0, _objFilter2.default)(conflicting, function (k, v) {
      return !localLookup[k];
    });
