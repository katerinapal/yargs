...
var _whichModule = require("which-module");

var _whichModule2 = _interopRequireDefault(_whichModule);
...
var applyMiddleware = _middleware2.default.applyMiddleware,
    commandMiddlewareFactory = _middleware2.default.commandMiddlewareFactory;
...
function command(yargs, usage, validation, globalMiddleware) {
  ...
  self.addDirectory = function addDirectory(dir, context, req, callerFile, opts) {
    ...
    (0, _requireDirectory2.default)({ require: req, filename: callerFile }, dir, opts);
  };

  // lookup module object from require()d command and derive name
  // if module was not require()d and no name given, throw error
  function moduleName(obj) {
    var mod = (0, _whichModule2.default)(obj);
  ...
  self.runCommand = function runCommand(command, yargs, parsed, commandIndex) {
    ...
    if (commandHandler.handler && !yargs._hasOutput()) {
      ...
      var handlerResult = (0, _isPromise2.default)(innerArgv) ? innerArgv.then(function (argv) {
        return commandHandler.handler(argv);
      }) : commandHandler.handler(innerArgv);

      if ((0, _isPromise2.default)(handlerResult)) {
  ...
  function postProcessPositionals(argv, positionalMap, parseOptions) {
    ...
    var parsed = _yargsParser2.default.detailed(unparsed, options);
